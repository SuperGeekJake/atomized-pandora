...
var decipher = crypto.createDecipheriv('bf-ecb', new Buffer(api.decryptKey), '');
var cipher = crypto.createCipheriv('bf-ecb', new Buffer(api.encryptKey), '');
...
pandora.encrypt = function(nonciphered) {
  var ciphered = cipher.update(new Buffer(nonciphered), null, 'hex');
